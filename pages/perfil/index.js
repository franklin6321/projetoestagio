                ...
                <div>
                    ...
                    <div className={styles.containerContent}>
                        <Link className={styles.link} to={`/administracao`}>
                            ...
                            <div >
                                <h2 className={styles.wellcome}>Estatística</h2>
                    ...
                    <div className={styles.containerContent}>
                        <Link className={styles.link} to={`/administracao`}>
                            ...
                            <div >
                                <h2 className={styles.wellcome}>Comportamento Organizacional</h2>
                    ...
                    <div className={styles.containerContent}>
                        <Link className={styles.link} to={`/administracao`}>
                            ...
                            <div >
                                <h2 className={styles.wellcome}>Matemática Administrativa</h2>
